export default function CountCard() {
  return (
    <div className="bg-background flex w-full flex-col rounded-3xl shadow-xl md:w-1/2 xl:m-7">
      <h1 className="p-5 text-xl font-extrabold">Count</h1>
      <div className="m-3 flex flex-wrap justify-around gap-4 md:flex-nowrap">
        <div className="bg-secondary w-full rounded-2xl border-b-4 border-lime-500 p-4 shadow-xl md:w-1/3">
        ...
        <div className="bg-secondary flex w-full items-center justify-between rounded-2xl border-b-4 border-red-500 p-4 shadow-xl md:w-1/3">
      ...
      <div className="m-3 mt-4 flex flex-wrap justify-around gap-4 md:flex-nowrap">
        <div className="bg-secondary w-full rounded-2xl border-b-4 border-cyan-600 p-4 shadow-xl md:w-1/3">
        ...
        <div className="bg-secondary flex w-full items-center justify-between rounded-2xl border-b-4 border-amber-300 p-4 shadow-xl md:w-1/3">
          <div className="text-gray-500">
